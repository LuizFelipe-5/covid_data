...
mixin _$CountryStore on _CountryStoreBase, Store {
  ...
  final _$countrySelectedAtom = Atom(name: '_CountryStoreBase.countrySelected');

  @override
  String get countrySelected {
  ...
  @override
  void setCountrySelected(String country) {
    final _$actionInfo = _$_CountryStoreBaseActionController.startAction(
        name: '_CountryStoreBase.setCountrySelected');
    try {
      return super.setCountrySelected(country);
    } finally {
      _$_CountryStoreBaseActionController.endAction(_$actionInfo);
    }
  }
